...
$(window).load(function() {
	...
	$(".border").each(function() {
		...
		if( $(this).children('a').hasClass('link') || $(this).children('a').hasClass('zoom') ) { // look for links
			...
			$(this).append('<div class="'+both+' mask" id="inputID'+specID+'"></div>');
			...
			$(this).children('a.link,a.zoom').each(function() {
				...
				$(this).siblings('.mask#inputID'+specID).append('<span class="'+ele+'"></span>');
				$(this).removeClass(ele).appendTo('.mask#inputID'+specID+' .'+ele);
			});
			$(this).mouseenter(function(){
